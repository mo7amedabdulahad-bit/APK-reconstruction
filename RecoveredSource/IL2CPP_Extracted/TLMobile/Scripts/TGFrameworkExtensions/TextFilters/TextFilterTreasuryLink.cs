...
// Source: global-metadata.dat (Travian Legends Mobile v3.13.0)
	...
	public class TextFilterTreasuryLink : TextFilterClickableBase
	{
		// Fields
		private Building treasury;
		...
		// Constructors
		public TextFilterTreasuryLink() {}
	
		// Methods
		protected override string GetOutputString(int _) => default;
