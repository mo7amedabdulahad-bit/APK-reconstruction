...
// Source: global-metadata.dat (Travian Legends Mobile v3.13.0)
	...
	public class TextFilterRegionLink : TextFilterClickableBase
	{
		// Fields
		private Region fetchedRegionObject;
		...
		// Constructors
		public TextFilterRegionLink() {}
	
		// Methods
		protected override string GetOutputString(int regionId) => default;
