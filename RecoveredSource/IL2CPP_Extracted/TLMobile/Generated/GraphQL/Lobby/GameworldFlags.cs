...
// Source: global-metadata.dat (Travian Legends Mobile v3.13.0)
	...
	public class GameworldFlags : GraphQLServerObject
	{
		// Fields
		[ObservableValue]
		...
		// Constructors
		public GameworldFlags() {}
		public GameworldFlags(ApiMetadataFlags source) {}
		...
		private bool EqualToDTOAll(GameworldFlagsDTO dtoValue) => default;
		public override bool CopyValuesFromDTO(object newValues, int query = 0, bool beSilent = false) => default;
		public bool CopyValuesFromDTO(object newValues, Query query = Query.All, bool beSilent = false) => default;
		private bool CopyValuesFromDTOAll(GameworldFlagsDTO newValues, bool beSilent = false) => default;
