...
// Source: global-metadata.dat (Travian Legends Mobile v3.13.0)
	...
	public class OngoingCelebration : GraphQLServerObject, ITimedUpdater
	{
		// Fields
		[ObservableValue]
		...
		[ObservableValue]
		public bool displayDate { get => default; set {} }
		...
		private bool EqualToDTOAll(OngoingCelebrationDTO dtoValue) => default;
		public override bool CopyValuesFromDTO(object newValues, int query = 0, bool beSilent = false) => default;
		public bool CopyValuesFromDTO(object newValues, Query query = Query.All, bool beSilent = false) => default;
		private bool CopyValuesFromDTOAll(OngoingCelebrationDTO newValues, bool beSilent = false) => default;
