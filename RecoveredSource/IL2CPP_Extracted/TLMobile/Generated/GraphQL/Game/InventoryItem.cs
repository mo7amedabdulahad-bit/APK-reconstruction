...
// Source: global-metadata.dat (Travian Legends Mobile v3.13.0)
	...
	public class InventoryItem : GraphQLFetchable
	{
		// Fields
		[ObservableValue]
		private int _typeId;
		...
		private bool EqualToDTOAll(InventoryItemDTO dtoValue) => default;
		public override bool CopyValuesFromDTO(object newValues, int query = 0, bool beSilent = false) => default;
		public bool CopyValuesFromDTO(object newValues, Query query = Query.All, bool beSilent = false) => default;
		private bool CopyValuesFromDTOAll(InventoryItemDTO newValues, bool beSilent = false) => default;
		...
		public static IPromise<InventoryItem> PromiseGet(int inventoryItemId, Query query = Query.All, bool forceFetch = true) => default;
		public static IPromise<InventoryItem> PromiseGet(out InventoryItem cacheObject, int inventoryItemId, Query query = Query.All, bool forceFetch = true) {
			cacheObject = default;
			return default;
		}
		public static InventoryItem GetNoFetch(int inventoryItemId, Query query = Query.All) => default;
		public static InventoryItem Get(bool forceRefresh, int inventoryItemId, Query query = Query.All) => default;
		public static InventoryItem Get(int inventoryItemId, Query query = Query.All) => default;
		private static InventoryItem Fetch(InventoryItemSource origin, int inventoryItemId, Query query = Query.All, bool fetchIfMissing = true, ServerObject newObjectToUse = null, bool forceRefresh = false) => default;
		public void Update(Query queryType = Query.All) {}
		public override void Update(int queryType) {}
		public void ObserveOnce(Query queryType, System.Action callback, bool onlyReactOnServerData = true) {}
		public void StopObserveOnce(Query queryType, System.Action callback) {}
		public override string[] GetNamesInNestedResponse() => default;
		private static string GetRequestBodyPart(int inventoryItemId, object dummy = null) => default;
