...
// Source: global-metadata.dat (Travian Legends Mobile v3.13.0)
	...
	public class TextFilterFractionNumber : BaseTextFilter
	{
		// Properties
		...
		public override string OptionalStringName { get => default; }
		public override string OptionalStringName2 { get => default; }
		public override bool Inlineable { get => default; }
	
		// Constructors
		public TextFilterFractionNumber() {}
		...
		private static ValueTuple<int, int> DoubleToFractionSjaak(double value, double accuracy = 0.0001) => default;
		private static double RoundToTwoDigits(double value) => default;
	}
